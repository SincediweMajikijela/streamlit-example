...
# ---- READ FILES ----
dfAirport = pd.read_csv('airports.dat')
dfAirline = pd.read_csv('airliness.dat')
dfPlane=pd.read_csv('planes.dat')
dfCountry=pd.read_csv('countries.dat')
dfRoute=pd.read_csv('routes.dat')
